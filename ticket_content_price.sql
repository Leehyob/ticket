...
CREATE TABLE `content_price` (
  `price_code` bigint NOT NULL AUTO_INCREMENT,
  `price` varchar(255) DEFAULT NULL,
  `seat_level` varchar(255) DEFAULT NULL,
  `content_code` bigint DEFAULT NULL,
  PRIMARY KEY (`price_code`),
  KEY `FK9hxrk90kvue71ef9aawhgbu4m` (`content_code`),
  CONSTRAINT `FK9hxrk90kvue71ef9aawhgbu4m` FOREIGN KEY (`content_code`) REFERENCES `content` (`content_code`)
